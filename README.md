...
You can also run this project using Docker. Follow these steps:

1. **Build the Docker image:**
   ```bash
   docker build -t next_15 .
   ```

2. **Run the Docker container:**
   ```bash
   docker run -p 3000:3000 next_15
   ```
...
- **Next.js** new structure of _App Routing_ for _server-side_ rendering.
- Write end-to-end tests using **Cypress**.
- Implement and use **Docker** for containerizing the application.